...
// attendenceRouter.post('/mark', markAttendance);
// attendenceRouter.get('/view', getAllAttendance);

// export default attendenceRouter;

// backend/routes/AttendanceRoutes.js
// import express from 'express';
// import { markAttendance,getFacultyAttendance,getStudentAttendance  ,deleteFacultyAttendance,} from '../controller/AttendanceController.js';
...
// attendenceRouter.delete('/faculty/delete/:id', deleteFacultyAttendance); // delete faculty attendance
