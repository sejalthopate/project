...
const ManageClassView = () => {
  ...
  return (
    <div className="min-h-screen h-185 p-6 bg-gradient-to-br from-gray-900 via-purple-900 to-gray-800 text-white">
      ...
      {classes.length === 0 ? (
        ...
        <div className="overflow-auto rounded-xl border border-white/20 h-150 bg-purple-100/10 backdrop-blur-md shadow-lg">
          <table className="min-w-full text-sm text-white rounded-xl overflow-hidden border-separate border-spacing-0">
            <thead className="bg-purple-300/10 backdrop-blur-sm">
              <tr className="bg-white-300/10 backdrop-blur-sm">
            ...
            <tbody>
              {classes.map((cls) => (
                <tr key={cls._id} className="border-t border-slate-700">
